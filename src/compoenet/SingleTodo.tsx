...
const SingleTodo = ({ index, todo }: Props) => {
  ...
  // let edit = useSelector(selectEdit);

  // const [edit, setEdit] = useState<boolean>(false);
  // const [editTodo, setEditTodo] = useState<string>(todo.todo);

  const handleDone = (id: number, todo: string, isDone: boolean) => {
    dispatch(done({ id, todo, isDone }));
      ...
      {(provided) => (
        ...
        >
          ...
          <div>
            ...
            <span
              className="icon"
              onClick={() => handleDone(todo.id, todo.todo, todo.isDone)}
            >
              <MdDone />
            </span>
          </div>
